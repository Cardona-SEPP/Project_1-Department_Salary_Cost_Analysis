...
SELECT COALESCE(es.dept_id, 'Unknown') AS department_id,
	COALESCE(pd.department_name, 'Unknown') AS department_name, # Label unknowns
    SUM(es.salary) AS department_salary_cost,
